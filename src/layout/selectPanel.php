        ...
        <div class="d-flex position-relative w-100 align-items-center">
            <div class="d-flex justify-content-center gap-2 w-100" id="startBtns">
                ...
                <button id="templates" type="button" class="btn text-dark start-btn"
                    style="border-color: #006c99; border-radius: 8px; background-color: rgba(255, 255, 255, 0.952);">Templates</button>
            ...
            <button id="logout" type="button" class="btn text-dark start-btn position-absolute ms-auto end-0 me-4" 
